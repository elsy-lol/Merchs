...
export const RecycleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="7 11 2 11 2 6" />
    <path d="M2 11l.13-.13C3.39 6.64 6.7 4 11 4c4.65 0 8.56 3 9.7 7" />
    <polyline points="17 13 22 13 22 18" />
    <path d="M22 13l-.13.13C20.61 17.36 17.3 20 13 20c-4.65 0-8.56-3-9.7-7" />
  </svg>
);
...
export const PaletteIcon = () => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.5-.7 1.5-1.5 0-.4-.13-.76-.36-1.04-.23-.28-.39-.68-.39-1.12 0-1.1 1.1-2 2.25-2H18c2.2 0 4-1.8 4-4 0-5.5-4.5-10-10-10z" />
  </svg>
);
